    ...
    <div class="wrap">
        ...
        <div class="col_1_of_login span_1_of_login">
            <div class="login-title">
                ...
                <p class="errorMessage" style="color: red;font-size:14px;float:right;margin-top: -30px;margin-right: 50px;">${requestScope.nologin}</p>
                <div class="comments-area">
                    <form id="loginForm" action="user/login" method="post">
                        <div>
                            ...
                            <p class="errorMessage" style="color:red;font-size: 16px;float:right;margin-top: -40px;">${requestScope.errorMessage}</p>
                        </div>
                        <div>
                            <p style="color: red;float: left;margin-right: 2px;margin-top: 5px">*</p>
                        ...
                        <p id="login-form-remember">
                            <label><a href="user/resetPasswordPrompt">忘 记 密 码 ? </a></label>
                        </p>
                        <button  id="btnSubmit" class="grey" type="submit">登录</button>
    ...
    <div class="wrap">
        <div class="section group">
            ...
            <div class="col_1_of_5 span_1_of_5">
                <h3 class="m_9">电视</h3>
                <ul class="list1">
                    <li><a href="goods/showDetails/7">液晶电视</a></li>
                    <li><a href="goods/showDetails/7">普通电视</a></li>
            ...
            <div class="col_1_of_5 span_1_of_5">
                ...
                <ul class="list1">
                    <li><a href="goods/showDetails/7">空调</a></li>
