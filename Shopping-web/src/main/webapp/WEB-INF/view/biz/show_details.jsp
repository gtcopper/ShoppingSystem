...
<head>
    <base href="<%=basePath %>">
    <title>${requestScope.goods.goodsName}商品详情</title>
    <!--网页标题左侧显示-->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#btnSub").click(function () {
                ...
                $("#goodsSum").val(parseInt($("#goodsSum").val())-1);
            });
        ...
        <div class="cont span_2_of_3">
            <div class="labout span_1_of_a1">
                ...
                <ul id="etalage">
                    <li>
                        <a href="#">
                            <img class="etalage_thumb_image"  src="${requestScope.goods.goodsImage}" />
                            <img class="etalage_source_image" src="${requestScope.goods.goodsImage}" />
                        </a>
                    </li>
                </ul>
                <!-- end product_slider -->
            ...
            <div class="cont1 span_2_of_a1">
                <h3 class="m_3">${requestScope.goods.goodsName}</h3>

                <div class="price_single">
                    <span class="actual">${requestScope.goods.goodsPrice}元</span>
                </div>
                <div class="btn_form">
                    <h4 class="m_9">选择您需要加入购物车的数量</h4>
                    <form id="cartForm" action="cart/addToCart" method="post">
                        ...
                        <input id="goodsSum" name="goodsSum" type="text" value="1" style="height: 20px;width: 20px;text-align: center;">
                        <button id="btnAdd" type="button" style="margin-bottom: 20px;">+</button><br/>
                        <button id="btnSubmit" type="button" class="grey" style="float: left;margin-left: 250px;">
                            加入购物车
                        </button>
                    </form>
                </div>
    ...
    $(document).ready(function() {
        ...
        $("#btnSubmit").click(function () {
            $.ajax({
                ...
                dataType: 'json',
                data: JSON.stringify(getFormData($("#cartForm"))),
