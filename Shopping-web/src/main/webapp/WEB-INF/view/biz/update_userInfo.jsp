...
<div class="register_account">
    <div class="wrap">
        <h4 class="title">修 改 信 息</h4>
        <form id="registerForm" action="user/updateUserInfo" method="post">
            <div class="col_1_of_2 span_1_of_2">
                <div>
                    ...
                    <input type="text" id="userName" name="userName"  autofocus="true" value="${sessionScope.user.userName}" placeholder="用户名" required>
                </div>
                <div>
                    <p style="color: red;float: left;margin-right: 2px;margin-top: 5px;">*</p>
                    <label for="email" style="font-size: 14px;margin-right: 4px;">邮箱:</label>
                    <input type="text" id="email" name="email" value="${sessionScope.user.email}"  placeholder="邮箱" required>
                </div>
                <div>
                    <p style="color: red;float: left;margin-right: 2px;margin-top: 5px;">*</p>
            ...
            <div class="col_1_of_2 span_1_of_2">
                <div>
                    ...
                    <input type="text" id="address" name="address" value="${sessionScope.user.address}" placeholder="收获地址" required>
                </div>
                <div>
                    <p style="color: red;float: left;margin-right: 2px;margin-top: 5px;">*</p>
                    <label for="phone" style="font-size: 14px;margin-right: 4px;">手机号码:</label>
                    <input type="text"  id="phone" name="phone" value="${sessionScope.user.phone}" placeholder="手 机 号 码" required>
                </div>
            </div>
            <button id="btnSubmit" class="grey" type="button">确认修改信息</button>
            <%--<input class="grey" type="submit" value="注册">--%>
            <p id="nullText" class="errorMessage"></p>
            <p class="errorMessage">${requestScope.errorMessage}</p>
            <p class="terms">* 每天可修改一次用户名  <a href="#">温馨提示</a>.</p>
            <div class="clear"></div>
        </form>
    </div>
</div>
