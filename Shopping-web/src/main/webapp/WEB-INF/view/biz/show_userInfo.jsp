        ...
        <form id="registerForm" method="post">
            <div class="col_1_of_2 span_1_of_2">
                ...
                <div>
                    ...
                    <input type="text" id="email" name="email"  readonly="readonly" value="${sessionScope.user.email}">
                </div>
                <div>
                    <p style="color: red;float: left;margin-right: 2px;margin-top: 5px;">*</p>
                    <label for="userCreateTime" style="font-size: 14px;margin-right: 4px;">用户创建时间:</label>
                    <input type="text" id="userCreateTime" name="userCreateTime" readonly="readonly" value="<fmt:formatDate value="${sessionScope.user.userCreateTime}" pattern="yyyy/MM/dd hh:mm:ss aa" />">
                </div>
            </div>
            <div class="col_1_of_2 span_1_of_2">
                <div>
                    ...
                    <input type="text" id="address" name="address" readonly="readonly" value="${sessionScope.user.address}">
                </div>
                <div>
                    <p style="color: red;float: left;margin-right: 2px;margin-top: 5px;">*</p>
                    <label for="phone" style="font-size: 14px;margin-right: 4px;">手机号码:</label>
                    <input type="text"  id="phone" name="phone" readonly="readonly" value="${sessionScope.user.phone}">
                </div>
                <div>
                    <p style="color: red;float: left;margin-right: 2px;margin-top: 5px;">*</p>
                    <label for="userUpdateTime" style="font-size: 14px;margin-right: 4px;">上次更新信息时间:</label>
                    <input type="text" id="userUpdateTime" name="userUpdateTime" readonly="readonly" value="<fmt:formatDate value="${sessionScope.user.userUpdateTime}" pattern="yyyy/MM/dd hh:mm:ss aa" />">
                </div>
            </div>
            <button id="btnSubmit" class="grey" type="button"><a href="user/updateUserInfoPrompt">修改信息</a></button>
