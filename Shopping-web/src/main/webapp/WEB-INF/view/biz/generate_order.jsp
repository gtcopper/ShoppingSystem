...
<div class="login">
    <div class="wrap">
        ...
        <div class="clear"></div>
        <c:forEach items="${sessionScope.orderItemBodyLists}" var="item">
            <div style="border:1px solid #000;">
                    ...
                    <p style="float: left;margin-left: 20px;margin-top: 98px;">${item.goodsSum}件</p>
                <p style="float: left;margin-left: 60px;margin-top: 98px;color: red;">单项商品总金额:   <span>${item.singleGoodsPrice}元</span></p>
                    <div class="clear"></div>
            </div>
        </c:forEach>
        <div class="clear"></div>
        <div>
            <p class="totalPrice" style="float: right;margin-left: 20px; margin-right: 10px;color: #bd081c;font-size: 18px;">商品总价:        ${totalPrice}元</p>
            <div class="clear"></div>
            <form id="confirmForm" action="order/confirmOrder" method="post">
                <input  name="cartItemId[]" type="hidden" value="${requestScope.cartItemId}">
                <input type="hidden" name="orderId" value="${sessionScope.orderId}">
                <button style="float: right;margin-top: 20px;" class="grey2" id="confirmSubmit" type="button">确认订单</button>
            </form>
            <form id="cancelForm" action="order/cancelOrder" method="post">
                <input type="hidden" name="orderId" value="${sessionScope.orderId}">
                <button style="float: left;margin-top: 20px;"  class="grey2" id="cancelSubmit" type="button">取消订单</button>
            </form>
        </div>
        <div class="clear"></div>
    </div>
